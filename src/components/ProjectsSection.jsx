...
const projects = [
    ...
    },
    {
      ...
      title: "Hotel Booker",
      description: 
        "A full-stack hotel booking application built with the MERN stack, offering seamless room search, booking, and user management.",
      ...
      <section id="projects" className="py-24 px-4 relative">
        ...
        <div className="text-center mt-12">
            <a 
              ...
              target="_blank"
              href="https://github.com//Hariprasath-2218"
            >
